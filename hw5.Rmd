...
* Comments: The 50 cities in the dataset shows that Chicago is the city where the cases are not solved are the most, and it keeps a nearly 60% homicide cases unsettled.

* Richmond keeps the lowest rate of unsolved cases ratio among the 50 cities(around 20%).
